...
RUN wget -qO - http://deb.debian.org/debian/archive/bookworm/signing-key.asc | gpg --dearmor | tee /usr/share/keyrings/debian-archive-bookworm-keyring.gpg >/dev/null
